    ...
    <div className="space-y-6 font-sans">
      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-gray-500 mt-1">View and manage users within this tenant.</p>
        </div>
        <button 
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        {loading ? (
          <div className="p-12 text-center text-gray-500 animate-pulse">Loading directory...</div>
        ) : users.length === 0 ? (
          <div className="p-12 text-center">
            <User className="w-12 h-12 text-gray-300 mx-auto mb-4" />
            <h3 className="text-lg font-medium text-gray-900">No users found</h3>
            <p className="text-gray-500 mt-1">There are no users in this tenant yet.</p>
          </div>
        ) : (
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-500 font-mono mt-0.5">{user.id.substring(0, 13)}...</div>
                        </div>
                      </div>
                    </td>
                    <td className="py-4 px-6">
